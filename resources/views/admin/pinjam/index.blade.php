      ...
      <div class="row">
        <div class="col-12">
          ...
          <div style="font-size: 12px;color: white;">
            List data Pinjam berisi data lengkap dari data-data Pinjam, dan mengubah data Pinjam.
          </div>
        </div>
        <!-- <div class="col-12">
          <button onclick="Tambah();" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Pinjam</button>
        </div> -->
      </div>
      <hr>
    </div>
      ...
      if (empty) { 
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            setTimeout(function(){ window.location.href = '/pinjam'; }, 2000);

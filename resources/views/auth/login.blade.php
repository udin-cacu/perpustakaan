...
<head>
  ...
  <title>Login | Library University</title>
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="col-6 my-3 alert alert-success">
                <p><h4>{{ $message }}</h4></p>
              </div>
              @endif
              <!-- Logo -->
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <img src="/assets2/img/icons/Logo Poltekkes Surabaya.png" width="18%">
                  
                  <span class="app-brand-text demo text-body fw-bolder">Login Library University</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Selamat Datang! 👋</h4>
              <p class="mb-4">Mohon untuk sign-in ke Akun Anda untuk masuk ke aplikasi</p>
              ...
              <form method="POST" action="{{ route('login') }}">
                ...
                <hr>
                <div class="mb-3">
                  <a href="/" lass="btn btn-primary d-grid w-100">Back To Home</a>
                </div>
              </form>
